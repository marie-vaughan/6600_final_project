...
def analyze_album_cover_with_clip(image_url, categories=None, device=device, retry_count=3):
    ...
    if categories is None:
        ...
        categories = [
            # People
            "one person", "two people", "multiple people", "group photo", "band members", "no people",
            
            # Photographic styles
            "portrait", "close-up shot", "full body shot", "side profile", "silhouette",
            
            # Scene types
            "nature scene", "urban scene", "indoor scene", "outdoor scene", "studio photo",
            "concert scene", "stage performance", "beach scene", "city streets", "forest scene",
            "desert scene", "mountain scene", "water scene", "abstract background",
            
            # Visual styles
            "black and white photography", "color photography", "vintage style", "modern style",
            "minimalist design", "maximalist design", "abstract art", "realistic photo",
            "illustrated cover", "graphic design", "artistic", "photographic", "text heavy design",
            "simple design", "complex design", "surreal design", "psychedelic design",
            
            # Mood/atmosphere  
            "dark mood", "bright mood", "neutral mood", "happy vibe", "sad vibe", "angry vibe",
            "mysterious vibe", "energetic vibe", "calm vibe", "nostalgic feeling",
            "dramatic lighting", "natural lighting", "high contrast", "low contrast",
            
            # Specific elements
            "musical instruments", "microphone", "guitar", "drums", "piano", "text overlay",
            "logo visible", "album name visible", "band name visible", "landscape orientation",
        ...
        try:
            ...
            grouped_results = {
                ...
                "scene": [r for r in results if any(term in r["category"].lower() for term in 
                         ["scene", "indoor", "outdoor", "studio", "nature", "urban"])],
                ...
                "elements": [r for r in results if any(term in r["category"].lower() for term in 
                            ["instrument", "microphone", "guitar", "drums", "piano", "text", "logo"])]
            }
...
if __name__ == "__main__":
    ...
    main(
        csv_file='albums_genres_cleaned.csv',  # Path to your CSV file
